...
export default function VideoComment({ videoId }) {
  ...
  const showError = () => {
    toast.current.show({
      severity: 'error',
      summary: 'Error!',
      detail: 'You are not logged in. Log in to comment and like.',
      life: 3000,
    });
  };
        ...
        <DialogContent>
          <div className="container justify-content-center mt-5 border-left border-right">
            {noVideoComments ? (
                  ...
                  <div className="d-flex justify-content-between py-1 pt-2">
                    <div>
                      <span className="text2">
                        No comments on this video yet. Click add Comment below
                        to leave a comment
                      </span>
                    </div>
                  </div>
              ...
              videoCommentsItems?.map((doc, index) => (
